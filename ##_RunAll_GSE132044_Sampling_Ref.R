...
# load("D:/Dropbox/##_GitHub/###_VUMC/CreateDataset/Input_Dataset/GSE132044/GSE132044_Sampling_Sample/GSE132044_10xV2_Sample_CellNum1681_Seed123_Processed.RData")
# Actual_Cell_Type <- seuratObject@meta.data$Actual_Cell_Type %>% unique()
# Actual_Cell_Type <- c("None", Actual_Cell_Type)
# rm(seuratObject)

Actual_Cell_Type <- c("None")
