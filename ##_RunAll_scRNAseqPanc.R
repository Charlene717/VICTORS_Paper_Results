...
#### Set Parameter ####
GSE_Name = "scRNAseqPanc"

#### Load Data Path ####
# Load a specific .RData file to get Actual_Cell_Type
load("D:/Dropbox/##_GitHub/###_VUMC/CreateDataset/Input_Dataset/Pancreas/IntCT_scRNAseq_Muraro/IntCT_scRNAseq_Muraro_Ref/MuraroPancreasData.RData")
...
Path_Sample_Folder1 <- "D:/Dropbox/##_GitHub/###_VUMC/CreateDataset/Input_Dataset/Pancreas/IntCT_scRNAseq_Muraro/IntCT_scRNAseq_Muraro_Samp"
Path_Sample_Folder2 <- "D:/Dropbox/##_GitHub/###_VUMC/CreateDataset/Input_Dataset/Pancreas/IntCT_scRNAseq_Baron/IntCT_scRNAseq_Baron_Samp"

Path_Ref_Folder <- "D:/Dropbox/##_GitHub/###_VUMC/CreateDataset/Input_Dataset/Pancreas/IntCT_scRNAseq_Ref"

# Get the list of all .RData files from both folders
files_Sample1 <- list.files(Path_Sample_Folder1, pattern = "\\.RData$", full.names = TRUE)
files_Sample2 <- list.files(Path_Sample_Folder2, pattern = "\\.RData$", full.names = TRUE)

files_Sample <- c(files_Sample1,files_Sample2)
