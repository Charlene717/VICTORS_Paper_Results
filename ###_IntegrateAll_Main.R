...
plots_final_Accuracy_data_SamePlat <- create_and_combine_metric_plots(data_same_platform, methods, Figure_Note, "Accuracy", "Same Platform", 4, legend_set, color_legend, set_x_col = "Mislabel_CellType")
plots_final_Accuracy_data_SamePlat
plots_final_Accuracy_data_CrossPlat <- create_and_combine_metric_plots(data_cross_platform, methods, Figure_Note, "Accuracy", "Cross Platform", 4, legend_set, color_legend, set_x_col = "Mislabel_CellType")
...
plots_final_Recall_data_SamePlat <- create_and_combine_metric_plots(data_same_platform, methods, Figure_Note, "Recall", "Same Platform", 4, legend_set, color_legend, set_x_col = "Mislabel_CellType")
plots_final_Recall_data_CrossPlat <- create_and_combine_metric_plots(data_cross_platform, methods, Figure_Note, "Recall", "Cross Platform", 4, legend_set, color_legend, set_x_col = "Mislabel_CellType")
...
plots_final_Specificity_data_SamePlat <- create_and_combine_metric_plots(data_same_platform, methods, Figure_Note, "Specificity", "Same Platform", 4, legend_set, color_legend, set_x_col = "Mislabel_CellType")
plots_final_Specificity_data_CrossPlat <- create_and_combine_metric_plots(data_cross_platform, methods, Figure_Note, "Specificity", "Cross Platform", 4, legend_set, color_legend, set_x_col = "Mislabel_CellType")
